...
const urlFR = 'https://fr.wikipedia.org/w/api.php?action=query&list=search&srlimit=20&format=json&origin=*&srsearch=searchValue';
...
const page_url_fr = 'href=http://fr.wikipedia.org/?curid=${pageid}';